...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop = [ //Name - Icon name - Description - Link - BG Color
			...
			['Dxgamer',		    'dxgamer',		    'Helper',	 'https://youtube.com/c/Dxgamer7405',	'0xFFC30085'],
			['Stage and phases of Corruption'],
			['TheOrda',		    'polybiusproxy',		    'Maked every stage and every phase',	 'https://www.youtube.com/channel/UCKiQ1fRDI0RPKIOI-TavcQw',	'0xFFC30085'],
			['Psych Engine Team'],
